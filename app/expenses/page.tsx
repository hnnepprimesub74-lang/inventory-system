...
export default function ExpensesPage() {
  ...
  async function load() {
    ...
    const { data: typeData } =
      await supabase.from('expense_types').select('*').order('name')
  ...
  async function addType() {
    ...
    const { error } =
      await supabase.from('expense_types').insert({ name })
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-1">
              ...
              Track expenses by type — Billing, Transport, Packaging and anything else
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="e.g. Electricity, Internet, Supplies"
              autoFocus
